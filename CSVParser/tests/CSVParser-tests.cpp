...
TEST_CASE("Test parseFile") {
    ...
    output = parser.parseFile("data/test_data_streamer_info.csv","data/test_data_friends.csv");

    vector<string> real_names{"CaptainTeabeard","AwakenedOne","CharlotteSomething", "Mizumomo", "onewithtehforce", "Aletdownofstate", "SkittlesRandom", "ShadowScissors_", "lemonlimepickle", "S1MPAGG"};

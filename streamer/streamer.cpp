...
Streamer::Streamer() {}
Streamer::Streamer(unsigned id, std::string name, unsigned views, unsigned age) : id_(id), name_(name), views_(views), age_(age) {}
...
void Streamer::setFriends(std::vector<unsigned> friends) {
  friends_ = friends;
}
